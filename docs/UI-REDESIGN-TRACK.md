...
|---|---|---|
| 7 | Agents/Extensions/Activity المتبقي في MainViewModel (628 سطراً) | الوكلاء (درزة activeAgent مع Studio/Tasks) ثم الامتدادات ثم تدفق النشاط — كلٌّ بـ GAP-21 |
| 8 | i18n قرار | D-1 موثّق (عربي فقط)؛ أي توسع لغوي = استخراج سلاسل |
