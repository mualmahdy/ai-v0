...
data class UiState(
    ...
    // Legacy model discovery (kept for the ModelsCapabilitiesScreen which
    // will be replaced in a follow-up commit).
    val providers: List<com.example.domain.core.provider.ProviderDescriptor> = emptyList(),
